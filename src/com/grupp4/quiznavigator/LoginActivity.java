...
import com.grupp4.quiznavigator.ui.MainMenuActivity;
...
public class LoginActivity extends Activity 
{
				...
				positiveButton.setOnClickListener(new View.OnClickListener() 
				{
					...
					public void onClick(View v) 
					{
								...
								&& !HuggUtils.checkIfEmpty(passwordText.getText().toString()))
						{
							...
							{
								QuizNavigatorDataSource.getInstance(LoginActivity.this).createAccount(eMailText.getText().toString(), passwordText.getText().toString(),
										true);
	 ...
	 * it send you to the MainMenuActivity. If the user input is not correct a Toast will notify the user. 
	 */
	public void tryLogin(View caller)
	{
		...
		String email;
		String password;
		List<Account> accounts = dbSrc.getAllAccounts(); //Ful lösning
